...
<!--      <el-button size="small" @click="handlePrint" type="primary">打印本页</el-button>-->
<!--    </div>-->
<!--  </div>-->
<!--</template>-->
...
<!--</style>-->
<template>
  <div class="union-search-detail">
    <Detail>
      <el-button slot="bottom-button" size="small" @click="handlePrint" type="primary">打印本页</el-button>
    </Detail>
  </div>
</template>

<script lang="ts">
import Detail from '@/views/specimen-management/detail.vue'
